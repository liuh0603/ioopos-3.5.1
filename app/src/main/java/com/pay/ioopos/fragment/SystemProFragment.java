 ...
 */
public class SystemProFragment extends AbstractFragment implements KeyInfoListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_system_pro, container, false);
    ...
    public boolean onKeyUp(KeyInfo keyInfo) {
        if (keyInfo == KEY_NUM_1) {
            setMainFragment(new PaySwitchProFragment());
            return true;
        } else if (keyInfo == KEY_NUM_2) {
            setMainFragment(new FaceSwitchFragment());
            return true;
