 ...
 */
public class CmdWalletPay extends AbstractCmdBlock {
    // 扣款金额，分
    private int amount;
    public CmdWalletPay(@NonNull KeyType type, @NonNull byte[] key, @NonNull int block, @NonNull int amount) {
    ...
    public byte[] createCmd() {
        ...
        cmd[2] = 0x0E;  // 长度
        cmd[3] = 0x09;  // 命令
        for (int i = 0; i < 4; i++) {// 扣款金额 4字节, 低字节在前
