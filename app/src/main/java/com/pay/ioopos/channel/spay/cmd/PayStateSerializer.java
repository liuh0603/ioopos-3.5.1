 ...
 * @since 2022/7/26
 */
public class PayStateSerializer extends SerialPortSerializer {
    ...
    public PayStateSerializer(@NonNull String amount, @NonNull State state) {
        this.amount = amount;
        this.state = state;
    }
    ...
    protected SerialPortBizType bizType() {
        return SerialPortBizType.PAY_STATE;
    }
