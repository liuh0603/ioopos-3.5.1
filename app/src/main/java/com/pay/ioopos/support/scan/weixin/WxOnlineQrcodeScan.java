 ...
 */
public class WxOnlineQrcodeScan extends ScanCaseAbstract {
    ...
    protected void onStart(LifecycleOwner owner) {
        MyWxPayFace.getInstance().startCodeScanner(new IWxPayfaceCallback() {
            @Override
    ...
    protected void onStop(LifecycleOwner owner) {
        MyWxPayFace.getInstance().stopCodeScanner();
    }
