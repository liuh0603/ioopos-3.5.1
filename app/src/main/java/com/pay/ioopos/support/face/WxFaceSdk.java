 ...
 */
public class WxFaceSdk {
    public static final boolean IS_OFFLINE = isOfflinePayFace();
    private static final String TAG = WxFaceSdk.class.getSimpleName();
    private static WxFaceSdk myWxPayFace = new WxFaceSdk();

    private WxFaceSdk() {

    }

    public static WxFaceSdk getInstance() {
        return myWxPayFace;
    }

    public static boolean isOfflinePayFace() {
        try {
    ...
    public static void onlineInvoke(String methodName, Map<String, Object> params, IWxPayfaceCallback iWxPayfaceCallback) {
        if (!isOfflinePayFace()) {
            try {
    ...
    public static void onlineInvoke(String methodName, IWxPayfaceCallback iWxPayfaceCallback) {
        if (!isOfflinePayFace()) {
            try {
    ...
    public static void onlineInvoke(String methodName) {
        if (!isOfflinePayFace()) {
            try {
    ...
    public static void offlineInvoke(String methodName, Map<String, Object> params, IWxPayfaceCallback iWxPayfaceCallback) {
        offlineInvoke(methodName, new Class[]{Map.class, IWxPayfaceCallback.class}, new Object[]{params, iWxPayfaceCallback});
    }

    public static void offlineInvoke(String methodName, Class[] clazzs, Object[] args) {
        if (isOfflinePayFace()) {
            try {
