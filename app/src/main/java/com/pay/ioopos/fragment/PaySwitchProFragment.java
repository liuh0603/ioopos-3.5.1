 ...
 */
public class PaySwitchProFragment extends AbstractFragment implements KeyInfoListener {

    private View view;
    private Switch scanPay;
    private Switch nfcPay;
    private Switch facePay;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_pay_switch_pro, container, false);
        ...
        // 刷脸开关
        facePay = view.findViewById(R.id.switch_face_pay);
        facePay.setOnKeyListener(listener);
        facePay.setChecked(store.getSwitchFacePay());
    ...
    public boolean onKeyUp(KeyInfo keyInfo) {
        switch (keyInfo) {
            ...
            case KEY_NUM_2:
                ...
                return true;
            case KEY_NUM_3:
                facePay.setChecked(!facePay.isChecked());
                store.setSwitchFacePay(facePay.isChecked());
                return true;
            case KEY_NUM_4:
